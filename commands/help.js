...
module.exports.run = async (client, message, args, prefix) => {
    if (!args[0]) {
        ...
        .addField("Liens", `[Bot Invite](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8) • [Support](${client.configs.support}) • [Top.gg](https://top.gg/bot/804289381141446666/) • [Site](${client.configs.dashboard.url}:${client.configs.dashboard.port})`)
