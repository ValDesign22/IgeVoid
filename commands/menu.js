...
module.exports.run = async (client, message, args, prefix) => {
    ...
    if (!message.member.voice.channel) return message.error(`Vous n'êtes pas dans un salon vocal.`, message, client);

    if (message.guild.me.voice.channel && message.member.voice.channel.id !== message.guild.me.voice.channel.id) return message.error(`Vous n'êtes pas dans le même canal vocal que moi.`, message, client);
